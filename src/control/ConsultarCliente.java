...
public class ConsultarCliente extends javax.swing.JInternalFrame {
	...
	public ConsultarCliente( JDesktopPane jdp ) {
		...
		try {
			...
			while( resultSet.next() ) {
				String[] linha = { resultSet.getString( "cpf" ), resultSet.getString( "nome" ), resultSet.getString( "telefone" ),
	...
	private void initComponents() {
		...
		jtCliente.setModel( new javax.swing.table.DefaultTableModel( new Object[][] {

		}, new String[] { "CPF", "Nome", "Telefone", "Dt. Nascimento" } ) {
	...
	private void btExcluirActionPerformed( java.awt.event.ActionEvent evt ) {
		try {
			...
			statement.setString( 1, jtCliente.getValueAt( linha, 0 ).toString() );
			statement.execute();
			statement.close();
			connection.close();
			DefaultTableModel model = ( DefaultTableModel ) jtCliente.getModel();
